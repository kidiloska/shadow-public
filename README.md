...
Can be found on telegram as [shadow](https://t.me/shadow).

The Support group can be reached out to at [One Punch Support](https://t.me/OnePunchSupport), where you can ask for help about @shadow, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
### Read these notes carefully before proceeding 
 ...
 - Your code must be open source and a link to your fork's repository must be there in the start reply of the bot. [See this](https://github.com/AnimeKaizoku/shadow/blob/shiken/shadow/__main__.py#L25)
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/AnimeKaizoku/shadow.git)

</details>  
<details>
  <summary>Steps to self Host!! </summary>

Note: This instruction set is just a copy-paste from Marie, note that [One Punch Support](https://t.me/OnePunchSupport) aims to handle support for @shadow and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
...
This file should be placed in your `shadow` folder, alongside the `__main__.py` file. 
...
```
from shadow.sample_config import Config
